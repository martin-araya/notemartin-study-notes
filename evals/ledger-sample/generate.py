#!/usr/bin/env python3
"""Genera los 5 ledgers sintéticos para Fase 15.
...
def mk(unit_id: str, blocks: list[str], section: str, type_: str,
       ...
       state: str, discard_reason: str | None = None) -> dict:
    e: dict = {
        "unit_id": unit_id,
...
def full_coverage() -> dict:
    return {
        ...
        "entries": [
            ...
            mk("u_006", [block_id("pg/note-1")], "/ch02/intro", "note", "context",
               None, None, "written"),
            mk("u_007", [block_id("pg/tip-1")], "/ch02/intro", "tip", "context",
...
def mixed_states() -> dict:
    ...
    return {
        ...
        "entries": [
            ...
            mk("u_014", [block_id("k/toc-1")], "/toc", "navigation", "must-keep",
               "kubernetes-pod-v1", None, "discarded", "navigation"),
            mk("u_015", [block_id("k/dup-1")], "/workload/pod-v1", "definition", "must-keep",
               "kubernetes-pod-v1", None, "discarded", f"redundant-with:u_010"),
        ],
    }
